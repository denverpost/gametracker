...
<title>Choose a Game | Gametracker from The Denver Post</title>

<meta name="viewport" content="width=device-width">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

<meta name="twitter:card" value="summary" />
<meta name="twitter:url" value="http://gametracker.denverpost.com/" />
<meta name="twitter:title" value="Gametracker from The Denver Post" />
<meta name="twitter:description" value="Denver Post Gametracker: Live updates, news, photos, videos and more" />
<meta name="twitter:image" value="http://gametracker.denverpost.com/gametracker-fb-image.png" />
...
<meta property="og:title" content="Gametracker from The Denver Post" />
<meta property="og:type" content="website" />
<meta property="og:url" content="http://gametracker.denverpost.com/" />
<meta property="og:image" content="http://gametracker.denverpost.com/gametracker-fb-image.png" />
<meta property="og:site_name" content="Gametracker from The Denver Post" />
<meta property="og:description" content="Denver Post Gametracker: Live updates, news, photos, videos and more" />
<meta property="article:publisher" content="https://www.facebook.com/denversports" />

<meta name="distribution" content="global" />
<meta name="robots" content="follow, all" />
<meta name="language" content="en, sv" />
<meta name="Copyright" content="Copyright &copy; The Denver Post." />
<link rel="canonical" href="http://gametracker.denverpost.com/" />
<meta name="news_keywords" content="Denver, Broncos, Colorado, Rockies, Avalanche, Nuggets, CU, CSU, Rams, Buffs, Buffaloes, NBA, NHL, NFL, playoffs, stats, live, video, photos, score, updates" />
...
//Configure DFM Variables
    ...
    dfm.api("data","siteName",        "Denver Post Gametracker"); //Assign user-friendly name for site
    dfm.api("data","siteDomain",      "gametracker.denverpost.com"); //Domain of the News.com, WordPress, Blog
    dfm.api("data","actualDomain",    "gametracker.denverpost.com");//Full URl of site
    dfm.api("data","localCommonUrl",  "");
    dfm.api("data","localAssetsUrl",  "");
    dfm.api("data","contentId",       "Denver Post Gametracker");
    dfm.api("data","sectionName",     "Denver Post Gametracker"); //Omniture section/category name
    dfm.api("data","pageId",          "");
    dfm.api("data","pageUrl",         "http://gamecenter.denverpost.com/"); //Full URl of site
    dfm.api("data","pageVanityUrl",   "http://gamecenter.denverpost.com/"); //Full URl of site
    dfm.api("data","pageTitle",       "Gametracker from The Denver Post");
    dfm.api("data","pageType",        "");
    dfm.api("data","abstract",        "Denver Post Gametracker: Live updates, news, photos, videos and more");
    dfm.api("data","keywords",        "Denver, Broncos, Colorado, Rockies, Avalanche, Nuggets, CU, CSU, Rams, Buffs, Buffaloes, NBA, NHL, NFL, playoffs, stats, live, video, photos, score, updates");
    dfm.api("data","title",           "Denver Post Gametracker: Live updates, news, photos, videos and more");
    dfm.api("data","sectionId",       "Denver Post Gametracker");
    dfm.api("data","slug",            "gametracker");
    dfm.api("data","byline",          "The Denver Post");
    dfm.api("data","NetworkID",       "8013");
    dfm.api("data","Taxonomy1",       "Gametracker");
    dfm.api("data","Taxonomy2",       "");
...
<script type="text/javascript">
    ...
    /** CONFIGURATION START **/
    _sf_async_config.title = "Gametracker from The Denver Post";
    _sf_async_config.uid = 2671;
    _sf_async_config.domain = "denverpost.com";
    _sf_async_config.sections = "Gametracker";
