...
<meta name="twitter:description" value="Denver Broncos vs. San Diego Chargers: Live updates, news, photos, videos and more" />
...
<meta property="og:description" content="Denver Broncos vs. San Diego Chargers: Live updates, news, photos, videos and more" />
...
<meta name="news_keywords" content="Denver Broncos, San Diego Chargers, Playoffs, NFL, playoff game, AFC, round 2, super bowl, game, stats, live, blog, video, photos, social, tracker, score, updates" />
...
//Configure DFM Variables
    ...
    dfm.api("data","abstract",        "Denver Broncos vs. San Diego Chargers: Live updates, news, photos, videos and more");
    dfm.api("data","keywords",        "Denver Broncos, San Diego Chargers, Playoffs, NFL, playoff game, AFC, round 2, super bowl, game, stats, live, blog, video, photos, social, tracker, score, updates");
    dfm.api("data","title",           "Denver Broncos vs. San Diego Chargers: Live updates, news, photos, videos and more");
...
<div id="topper">
    ...
    <div id="away">
        <img src="logo-chargers.png" alt="Chargers logo" />
        <span id="awayscore">-</span>
    </div>

    <div id="scores">
        <div class="teams"><h2>SD <span class="vs">vs</span> DEN</h2></div>
        <div class="gamedata"><span id="quarter"></span> <span id="bullet"></span> <time id="remaining"></time></div>
        <div class="gamedata"><span id="awayposs" class="possessors">&#x25c4;</span><span id="down"></span><span id="homeposs" class="possessors">&#x25ba;</span></div>
    </div>
...
<div id="adwrapper">
    ...
    <center>
    <div id='top_leaderboard' style="margin:5px auto;">
        <script type='text/javascript'>
            if ( $(window).width() > 740 ) {
    ...
    <div id='mobile_banner' style="margin:0 auto;">
        <script type='text/javascript'>
            if ( $(window).width() >= 300 && $(window).width() < 740 ) {
                googletag.defineSlot('/8013/denverpost.com/sports', [300,50], 'mobile_banner').setTargeting('pos',['Cube1_RRail_ATF']).setTargeting('kv', 'broncos_playoffs_2014').addService(googletag.pubads());
                googletag.pubads().enableSyncRendering();
                googletag.enableServices();
...
<div id="slider" class="swipe">
    <div class="swipe-wrap" id="slidehi">
        <div id="swipe1" class="slide">
            <iframe src="http://embed.scribblelive.com/Embed/v5.aspx?Id=351657&ThemeId=12700" width="100%" height="1000" frameborder="0" style="border: 1px solid #000;"></iframe>
        </div>
        <div id="swipe2" class="slide">
            <div class="gallerywrap">
                <iframe src="http://m.denverpost.sportsdirectinc.com/football/nfl-boxscores.aspx?page=/data/nfl/results/2013-2014/boxscore42012.html" style="height:7000px;width:100%;background:#fff;" frameborder="no"></iframe>
            </div>
        </div>
        ...
        <div id="swipe5" class="slide">
            <script type="text/javascript" class="rebelmouse-embed-script" src="http://www.rebelmouse.com/static/js-build/embed/embed.js?site=denverpost%2FBroncos-vs-Chargers&height=1500&flexible=1&theme=2000"></script>
        </div>
    </div>
</div>
...
<div id="bottombuttons">
    <ul>
        <li><a href="javascript:void(0)" onClick="mySwipe.slide(0,200)"><img src="button-live.png" />Live</a></li>
        <li><a href="javascript:void(0)" onClick="mySwipe.slide(1,200)"><img src="button-stats.png" />Stats</a></li>
        <li><a href="javascript:void(0)" onClick="mySwipe.slide(2,200)"><img src="button-media.png" />Media</a></li>
        <li><a href="javascript:void(0)" onClick="mySwipe.slide(3,200)"><img src="button-news.png" />News</a></li>
        <li><a href="javascript:void(0)" onClick="mySwipe.slide(4,200)"><img src="button-social.png" />Social</a></li>
    </ul>
</div>
    ...
    function parseGameData() {
        ...
        $.getJSON('./livescore.parse.php', function(data) {
            ...
            if (data["team-sport-content"]["league-content"]["competition"]["competition-state"]) {
                var possession = '#' + data["team-sport-content"]["league-content"]["competition"]["competition-state"]["possession"] + 'poss';
                ...
                if (keyEvent != null) {
                    ...
                    downDistanceOut = downPretty + ' and ' + distance;
                }
            ...
            if (data["team-sport-content"]["league-content"]["competition"]["result-scope"]) {
                ...
                if (data["team-sport-content"]["league-content"]["competition"]["result-scope"]["competition-status"] != 'complete') {
...
<script type="text/javascript">
    ...
    _sf_async_config.domain = "gametracker.denverpost.com";
