    ...
    <div class="swipe-wrap" id="slidehi">
        ...
        <div id="swipe2" class="slide">
            <div class="gallerywrap">
                <iframe src="<?php echo boxscore_url($config[0]); ?>" style="height:7000px;width:100%;background:#fff;" frameborder="no"></iframe>
            </div>
        </div>
